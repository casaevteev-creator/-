...
const ЖДЁМ = {
  ...
  /* меньше исходных 25 468 358: шесть пар перемещений между кассами на 40 500
     выброшены — передать кассу через этот обмен нечем, а пара даёт фантом на 57.01 */
  "ИНКАССАЦИЯ": "25 427 858",
  "ГРУПП-КАНДИДАТОВ": "5",
  "УЖЕ ПОГАШЕНО": "0",
  "НЕ ПРОВЕРЕНО": "3",
...
if (!всё.includes("Перемещения между кассами убраны: 6 пар на 40 500 ₽"))
  беда.push("перемещения между кассами не убраны");
