...
html = html.replace("${advSection()}", """<section class="tight advisor"><div class="w">
    <div class="kick">\u00a7\u00a7 · Вопросы</div><h2>Разобрать месяц глубже</h2>
    <div class="sb">В автономной версии разбор не считается — но сводку месяца можно унести с собой</div>
    ...
    и незакрытые сверки. Четыре тысячи символов, которые можно разобрать где угодно.
    Если открыть программу по ссылке, разбор считается прямо в отчёте.</div>
  </div></section>""")
