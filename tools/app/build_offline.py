...
# 4в. советчику нужен Claude — в автономной версии раздела нет
html = html.replace("${advSection()}", """<section class="tight advisor"><div class="w">
    <div class="kick">\u00a7\u00a7 · Советчик</div><h2>Спросить живого финдиректора</h2>
    <div class="sb">В автономной версии советчик не встроен — но сводку месяца можно унести с собой</div>
    <div class="dnote"><b>Кнопка «Сводка для ИИ»</b> на рабочем экране копирует и сохраняет текстом всё,
    на что опирается этот отчёт: выручку по группам и каналам, ряд по дням, статьи расходов, историю по месяцам
    и незакрытые сверки. Вставьте её в чат с Claude и спрашивайте что угодно — роль финдиректора там уже описана.
    Если открыть программу по ссылке, тот же советчик встроен прямо в отчёт.</div>
  </div></section>""")
