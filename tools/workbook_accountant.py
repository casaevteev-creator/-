...
def build(canon, out_path):
    ...
    for label, value, note in (
            ...
            ("Услуги банка, проведённые через счёт 60", man.get("bank_services_on_60"),
             "Альфа-Банк 668,56 и ВТБ 550,00 — ошибка проводки, место им на счёте 91; "
             "на итог не влияет, деньги посчитаны один раз"),
